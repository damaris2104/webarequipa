      ...
      <se:FeatureTypeStyle>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                ...
                <se:Stroke>
                  <se:SvgParameter name="stroke">#521cb0</se:SvgParameter>
          ...
          <se:PointSymbolizer>
            <se:Graphic>
              <se:Mark>
                <se:WellKnownName>hexagon</se:WellKnownName>
                <se:Fill>
                  <se:SvgParameter name="fill">#4f26c0</se:SvgParameter>
                  <se:SvgParameter name="fill-opacity">0.73</se:SvgParameter>
                </se:Fill>
                <se:Stroke>
                  <se:SvgParameter name="stroke">#3a2aba</se:SvgParameter>
        ...
        <se:Rule>
          ...
          <se:TextSymbolizer>
            ...
            <se:Fill>
              <se:SvgParameter name="fill">#b531ee</se:SvgParameter>
            </se:Fill>
          </se:TextSymbolizer>
        </se:Rule>
      </se:FeatureTypeStyle>
